    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[640px] max-h-[90vh] flex flex-col">
        ...
        <div className="space-y-4 py-2 min-h-0 flex-1 overflow-y-auto">
          ...
          <FormField label="System-Prompt Ausführung (Projekt-Level)" htmlFor="process-system-prompt">
            <p className="text-[11px] text-muted-foreground">
              Wird bei der Ausführung dieses Projekts als System-Prompt verwendet. Wird beim Erstellen eines Projekts aus diesem Prozess kopiert. Leer = globaler Fallback.
            </p>
            <PromptField
